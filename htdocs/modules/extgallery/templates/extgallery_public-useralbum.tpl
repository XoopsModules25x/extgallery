<{if $jquery}>
	...
	<{if $use_ajax_effects == tooltip}>
			<style>#screenshot img {max-width: <{$album_tooltip_width}>px; border: <{$album_tooltip_borderwidth}>px solid <{$album_tooltip_bordercolor}>;}</style>
	<{/if}>
...
<div class="extgallery">
	...
	<div class="center">
		...
		<div class="margin-top10">
			<a href="<{xoAppUrl modules/extgallery/}>public-useralbum.php?id=<{$extgalleryUID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_date&amp;orderby=DESC" title="<{$smarty.const._MD_EXTGALLERY_SORTDATEDESC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_up.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTDATEDESC}>" /></a>
			<span class="smallsort"><{$smarty.const._MD_EXTGALLERY_SORTDATE}></span>
			<a href="<{xoAppUrl modules/extgallery/}>public-useralbum.php?id=<{$extgalleryUID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_date&amp;orderby=ASC" title="<{$smarty.const._MD_EXTGALLERY_SORTDATEASC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_down.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTDATEASC}>" /></a>&nbsp;
			<a href="<{xoAppUrl modules/extgallery/}>public-useralbum.php?id=<{$extgalleryUID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_title&amp;orderby=ASC" title="<{$smarty.const._MD_EXTGALLERY_SORTNAMEASC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_up.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTNAMEASC}>" /></a>
			<span class="smallsort"><{$smarty.const._MD_EXTGALLERY_SORTNAME}></span>
			<a href="<{xoAppUrl modules/extgallery/}>public-useralbum.php?id=<{$extgalleryUID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_title&amp;orderby=DESC" title="<{$smarty.const._MD_EXTGALLERY_SORTNAMEDESC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_down.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTNAMEDESC}>" /></a>&nbsp;
			<a href="<{xoAppUrl modules/extgallery/}>public-useralbum.php?id=<{$extgalleryUID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_hits&amp;orderby=DESC" title="<{$smarty.const._MD_EXTGALLERY_SORTHITSDESC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_up.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTHITSDESC}>" /></a>
			<span class="smallsort"><{$smarty.const._MD_EXTGALLERY_SORTHITS}></span>
			<a href="<{xoAppUrl modules/extgallery/}>public-useralbum.php?id=<{$extgalleryUID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_hits&amp;orderby=ASC" title="<{$smarty.const._MD_EXTGALLERY_SORTHITSASC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_down.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTHITSASC}>" /></a>&nbsp;
			<a href="<{xoAppUrl modules/extgallery/}>public-useralbum.php?id=<{$extgalleryUID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_rating&amp;orderby=DESC" title="<{$smarty.const._MD_EXTGALLERY_SORTNOTEDESC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_up.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTNOTEDESC}>" /></a>
			<span class="smallsort"><{$smarty.const._MD_EXTGALLERY_SORTNOTE}></span>
			<a href="<{xoAppUrl modules/extgallery/}>public-useralbum.php?id=<{$extgalleryUID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_rating&amp;orderby=ASC" title="<{$smarty.const._MD_EXTGALLERY_SORTNOTEASC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_down.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTNOTEASC}>" /></a>
		</div>
	</div>
	<div class="pageNav">
		<{$pageNav}>
	   ...
	   <{/if}>
		...
		<{/if}>
            ...
            <!-- Start Normal show -->
	         <{if $use_ajax_effects == none}>
		         <{if $photos[photo].photo_serveur && $photos[photo].photo_name}>
					<a title="<{$photos[photo].photo_title}>" href="<{xoAppUrl modules/extgallery/}>public-userphoto.php?photoId=<{$photos[photo].photo_id}>"><img class="thumb" src="<{$photos[photo].photo_serveur}>thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" title="<{$photos[photo].photo_title}>" /></a>
					<{elseif $photos[photo].photo_name}>
					<a title="<{$photos[photo].photo_title}>" href="<{xoAppUrl modules/extgallery/}>public-userphoto.php?photoId=<{$photos[photo].photo_id}>"><img class="thumb" src="<{$xoops_url}>/uploads/extgallery/public-photo/thumb/thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" title="<{$photos[photo].photo_title}>" /></a>
					<{/if}>
			   <{/if}>
            <!-- End Normal show -->
           ...
           <!-- Start Tooltip show -->
	         <{if $use_ajax_effects == tooltip}>
		         <{if $photos[photo].photo_serveur && $photos[photo].photo_name}>
					<a class="screenshot" title="<{$photos[photo].photo_title}>" href="<{xoAppUrl modules/extgallery/}>public-userphoto.php?photoId=<{$photos[photo].photo_id}>" rel="<{$xoops_url}>/uploads/extgallery/public-photo/medium/<{$photos[photo].photo_name}>"><img class="thumb" src="<{$photos[photo].photo_serveur}>thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" title="<{$photos[photo].photo_title}>" /></a>
					<{elseif $photos[photo].photo_name}>
            ...
            <{if $use_ajax_effects == lightbox}>
	            <div id="gallery">
						<{if $photos[photo].photo_serveur && $photos[photo].photo_name}>
						<a title="<{$photos[photo].photo_title}>" href="<{$xoops_url}>/uploads/extgallery/public-photo/medium/<{$photos[photo].photo_name}>"><img class="thumb" src="<{$photos[photo].photo_serveur}>thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" title="<{$photos[photo].photo_title}>" /></a>
						<{elseif $photos[photo].photo_name}>
						<a title="<{$photos[photo].photo_title}>" href="<{$xoops_url}>/uploads/extgallery/public-photo/medium/<{$photos[photo].photo_name}>"><img class="thumb" src="<{$xoops_url}>/uploads/extgallery/public-photo/thumb/thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" title="<{$photos[photo].photo_title}>" /></a>
						<{/if}>
	            </div>
	         <{/if}>
	         <!-- End Lightbox -->
	         ...
	         <{if $use_ajax_effects == overlay}>
					<div align="center" id="apple">
						<{if $photos[photo].photo_serveur && $photos[photo].photo_name}>
						<img rel="#photo<{$photos[photo].photo_id}>" class="thumb" src="<{$photos[photo].photo_serveur}>thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" title="<{$photos[photo].photo_title}>" />
						<{elseif $photos[photo].photo_name}>
						<img rel="#photo<{$photos[photo].photo_id}>" class="thumb" src="<{$xoops_url}>/uploads/extgallery/public-photo/thumb/thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" title="<{$photos[photo].photo_title}>" />
						<{/if}>
					</div>
					<div class="apple_overlay" id="photo<{$photos[photo].photo_id}>"><a class="close"></a>
						...
						<div class="details">
							<{if $photos[photo].photo_serveur && $photos[photo].photo_name}>
							<div align="center"><a title="<{$photos[photo].photo_title}>" href="<{xoAppUrl modules/extgallery/}>public-userphoto.php?photoId=<{$photos[photo].photo_id}>"><{$photos[photo].photo_title}></a></div>
							<{elseif $photos[photo].photo_name}>
							<div align="center"><a title="<{$photos[photo].photo_title}>" href="<{xoAppUrl modules/extgallery/}>public-userphoto.php?photoId=<{$photos[photo].photo_id}>"><{$photos[photo].photo_title}></a></div>
							<{/if}>
            ...
            <!-- Start prettyPhoto show -->
	         <{if $use_ajax_effects == prettyphoto}>
	            <ul class="gallery clearfix">
			         <{if $photos[photo].photo_serveur && $photos[photo].photo_name}>
						<li><a title="<{$photos[photo].photo_title}>" href="<{$xoops_url}>/uploads/extgallery/public-photo/medium/<{$photos[photo].photo_name}>" rel="prettyPhoto[gallery2]"><img class="thumb" src="<{$photos[photo].photo_serveur}>thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" /></a></li>
						<{elseif $photos[photo].photo_name}>
						<li><a title="<{$photos[photo].photo_title}>" href="<{$xoops_url}>/uploads/extgallery/public-photo/medium/<{$photos[photo].photo_name}>" rel="prettyPhoto[gallery2]"><img class="thumb" src="<{$xoops_url}>/uploads/extgallery/public-photo/thumb/thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" /></a></li>
						<{/if}>
               </ul>
			   <{/if}>
         ...
         <{if $enable_info}>
				...
				<!-- Photo Title -->
				<{if $disp_ph_title == 1 }>
				<div class="photoTitle"><h2><a title="<{$photos[photo].photo_title}>" href="<{xoAppUrl modules/extgallery/}>public-userphoto.php?photoId=<{$photos[photo].photo_id}>"><{$photos[photo].photo_title}></a></h2></div>
				<{/if}>
				...
				<!-- Start photo date -->
				<{if $enable_date}>
				<div class="photoDate"><h5><{$smarty.const._MD_EXTGALLERY_INFODATE}> <{$photos[photo].photo_date}></h5></div>
				<{/if}>
				<!-- End photo date -->

				<!-- Start Submitter link -->
				<{if $enable_submitter_lnk}>
				<div class="photoSubmitter"><h4><a title="<{$photos[photo].user.uname}>" href="<{$xoops_url}>/userinfo.php?uid=<{$photos[photo].user.uid}>"><{$photos[photo].user.uname}></a></h4></div>
            <{/if}>
				<!-- End Submitter link -->
...
<{if $use_ajax_effects == prettyphoto}>
	...
	$(document).ready(function(){
		$(".gallery:gt(0) a[rel^='prettyPhoto']").prettyPhoto({animationSpeed:'<{$album_prettyphoto_speed}>',theme:'<{$album_prettyphoto_theme}>',slideshow:<{$album_prettyphoto_slidspeed}>, autoplay_slideshow: <{$album_prettyphoto_autoplay}>});
	});
	</script>
<{/if}>
