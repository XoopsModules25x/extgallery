<div class="extgallery">
    <form id="<{$send_ecard.name}>" action="<{$send_ecard.action}>" method="<{$send_ecard.method}>" <{$send_ecard.extra}>>
    <table class="outer">
    <tr>
    ...
    <tr>
        <td class="odd"><img src="<{xoAppUrl modules/extgallery/}>assets/images/captcha.php" alt="captcha" /></td>
