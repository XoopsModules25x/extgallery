...
<div class="extgallery">
    ...
    <div class="center">
        ...
        <div class="margin-top10">
            <a href="<{xoAppUrl modules/extgallery/}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_date&amp;orderby=DESC" title="<{$smarty.const._MD_EXTGALLERY_SORTDATEDESC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_up.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTDATEDESC}>" /></a>
            ...
            <a href="<{xoAppUrl modules/extgallery/}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_title&amp;orderby=ASC" title="<{$smarty.const._MD_EXTGALLERY_SORTNAMEASC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_up.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTNAMEASC}>" /></a>
            <span class="smallsort"><{$smarty.const._MD_EXTGALLERY_SORTNAME}></span>
            <a href="<{xoAppUrl modules/extgallery/}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_title&amp;orderby=DESC" title="<{$smarty.const._MD_EXTGALLERY_SORTNAMEDESC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_down.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTNAMEDESC}>" /></a>&nbsp;
            <a href="<{xoAppUrl modules/extgallery/}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_hits&amp;orderby=DESC" title="<{$smarty.const._MD_EXTGALLERY_SORTHITSDESC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_up.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTHITSDESC}>" /></a>
            <span class="smallsort"><{$smarty.const._MD_EXTGALLERY_SORTHITS}></span>
            <a href="<{xoAppUrl modules/extgallery/}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_hits&amp;orderby=ASC" title="<{$smarty.const._MD_EXTGALLERY_SORTHITSASC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_down.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTHITSASC}>" /></a>&nbsp;
            <a href="<{xoAppUrl modules/extgallery/}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_rating&amp;orderby=DESC" title="<{$smarty.const._MD_EXTGALLERY_SORTNOTEDESC}>"><img src="<{xoAppUrl /modules/extgallery/assets/images/sort_up.png}>" width="16" height="16" border="0" align="middle" alt="<{$smarty.const._MD_EXTGALLERY_SORTNOTEDESC}>" /></a>
       ...
       <{/if}>
        ...
        <{/if}>
           ...
           <!-- Start Normal show -->
             <{if $use_ajax_effects == none}>
                 <{if $photos[photo].photo_serveur && $photos[photo].photo_name}>
                    <a href="<{xoAppUrl modules/extgallery/}>public-photo.php?photoId=<{$photos[photo].photo_id}>"><img class="thumb" src="<{$photos[photo].photo_serveur}>thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" title="<{$photos[photo].photo_title}>" /></a>
                    <{elseif $photos[photo].photo_name}>
                    <a href="<{xoAppUrl modules/extgallery/}>public-photo.php?photoId=<{$photos[photo].photo_id}>"><img class="thumb" src="<{$xoops_url}>/uploads/extgallery/public-photo/thumb/thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" title="<{$photos[photo].photo_title}>" /></a>
                    <{/if}>
               <{/if}>
            <!-- End Normal show -->
           ...
           <!-- Start Tooltip show -->
             <{if $use_ajax_effects == tooltip}>
                 <{if $photos[photo].photo_serveur && $photos[photo].photo_name}>
                    <a class="screenshot" href="<{xoAppUrl modules/extgallery/}>public-photo.php?photoId=<{$photos[photo].photo_id}>" rel="<{$xoops_url}>/uploads/extgallery/public-photo/medium/<{$photos[photo].photo_name}>"><img class="thumb" src="<{$photos[photo].photo_serveur}>thumb_<{$photos[photo].photo_name}>" alt="<{$photos[photo].photo_title}>" title="<{$photos[photo].photo_title}>" /></a>
                    <{elseif $photos[photo].photo_name}>
            ...
            <{if $use_ajax_effects == lightbox}>
             ...
             <{if $use_ajax_effects == overlay}>
                    ...
                    <div class="apple_overlay" id="photo<{$photos[photo].photo_id}>"><a class="close"></a>
                        ...
                        <div class="details">
                            <{if $photos[photo].photo_serveur && $photos[photo].photo_name}>
                            <div align="center"><a href="<{xoAppUrl modules/extgallery/}>public-photo.php?photoId=<{$photos[photo].photo_id}>"><{$photos[photo].photo_title}></a></div>
                            <{elseif $photos[photo].photo_name}>
                            <div align="center"><a href="<{xoAppUrl modules/extgallery/}>public-photo.php?photoId=<{$photos[photo].photo_id}>"><{$photos[photo].photo_title}></a></div>
                            <{/if}>
            ...
            <{if $enable_info}>
                ...
                <!-- Photo Title -->
                <{if $disp_ph_title == 1 }>
                <div class="PhotoTitle"><h2><a href="<{xoAppUrl modules/extgallery/}>public-photo.php?photoId=<{$photos[photo].photo_id}>"><{$photos[photo].photo_title}></a></h2></div>
                <{/if}>
