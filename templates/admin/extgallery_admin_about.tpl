            ...
            <td class="aligntop width45">
                <fieldset>
                    ...
                    <div>
                        ...
                        <label><{$smarty.const._AM_EXTGALLERY_ABOUT_DESCRIPTION}></label>
                        <text><{$module_description}></text>
                        <br>
                        <label><{$smarty.const._AM_EXTGALLERY_ABOUT_AUTHOR}></label>
                        <text><{$module_author}></text>
                        <br>
                        <label><{$smarty.const._AM_EXTGALLERY_ABOUT_CREDITS}></label>
                        <text><{$module_credits}></text>
                        <br>
                        <label><{$smarty.const._AM_EXTGALLERY_ABOUT_LICENSE}></label>
                ...
                <fieldset>
                    ...
                    <div>
                        ...
                        <br>
                        <label><{$smarty.const._AM_EXTGALLERY_ABOUT_WEBSITE}></label>
                ...
                <fieldset>
                    ...
                    <div>
                        <label><{$smarty.const._AM_EXTGALLERY_ABOUT_AUTHOR_NAME}></label>
                        <text><{$module_author}></text>
                        <br>
                        <label><{$smarty.const._AM_EXTGALLERY_ABOUT_WEBSITE}></label>
